...
const ressourcesSlice = createSlice({
  ...
  extraReducers:(builder)=> {
    builder.addCase('ressources/fetchRessouces/fulfilled', (state,action)=>{
    ...
    builder.addDefaultCase(()=> {console.log('cas non pris en charge de déclenchement par asyncThuk')})
  }
});

//export const {} = ressourcesSlice.actions
export const fetchAllRessources= createAsyncThunk('ressources/fetchRessouces',
async()=> {
